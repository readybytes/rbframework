CREATE TABLE IF NOT EXISTS `#__xiee_invoice` (
...
CREATE TABLE IF NOT EXISTS `#__xiee_transaction` (
...
CREATE TABLE IF NOT EXISTS `#__xiee_modifier` (
...
CREATE TABLE IF NOT EXISTS `#__xiee_currency` (
...
CREATE TABLE IF NOT EXISTS `#__xiee_country` (
...
INSERT IGNORE INTO `#__xiee_currency` (`currency_id`, `title`, `published`, `params`, `symbol`) VALUES
...
INSERT IGNORE INTO `#__xiee_country` 
