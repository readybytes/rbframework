...
abstract class JHtmlJquery
{
	...
	public static function framework($noConflict = true, $debug = null)
	{
		...
		Rb_Html::_('script', 'rb/jui/jquery.min.js', false, true, false, false, $debug);

		// Check if we are loading in noConflict
		if ($noConflict)
		{
			Rb_Html::_('script', 'rb/jui/jquery-noconflict.js', false, true, false, false, false);
		}
	...
	public static function ui(array $components = array('core'), $debug = null)
	{
		...
		foreach ($components as $component)
		{
			...
			{
				Rb_Html::_('script', 'jui/jquery.ui.' . $component . '.min.js', false, true, false, false, $debug);
