...
abstract class JHtmlJquery
{
	...
	public static function framework($noConflict = true, $debug = null)
	{
		...
		Rb_Html::script('plg_system_rbsl/jui/jquery.min.js', false, true, false, false, $debug);

		// Check if we are loading in noConflict
		if ($noConflict)
		{
			Rb_Html::script('plg_system_rbsl/jui/jquery-noconflict.min.js', false, true, false, false, false);
		}
	...
	public static function ui(array $components = array('core'), $debug = null)
	{
		...
		foreach ($components as $component)
		{
			...
			{
				Rb_Html::script('jui/js/jquery.ui.' . $component . '.min.js', false, true, false, false, $debug);
